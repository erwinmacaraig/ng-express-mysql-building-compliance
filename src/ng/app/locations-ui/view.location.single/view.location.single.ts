...
@Component({
  ...
  templateUrl: './view.location.single.html',
  styleUrls: ['./view.location.single.css']
})
export class ViewLocationSingleComponent implements OnInit, OnDestroy {
	...
	ngOnInit(){
		...
		this.updateDonutChart('#specificChart', 30, true);
	}
